// q18: Rectangle with equal adjacent sides is a square
const DiagramRectangleAdjSides = (() => {
  function render(cfg={}) {
    const width=480, height=370;
    const red='#cc2222', black='#1a1a1a', blue='#2D5FA6';
    // Square: all sides 240px
    const A=Geo.point(120,65), B=Geo.point(360,65), C=Geo.point(360,305), D=Geo.point(120,305);
    ...
    parts.push(GeoRenderer.ticks(Geo.segment(A,B),{count:1,color:blue,tickLen:32,width:5}));
    parts.push(GeoRenderer.ticks(Geo.segment(A,D),{count:1,color:blue,tickLen:32,width:5}));
    parts.push(rightAngle(A,B,D,16));
    parts.push(rightAngle(B,C,A,16));
