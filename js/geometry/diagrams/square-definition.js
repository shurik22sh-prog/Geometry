// q19: Quadrilateral with 4 equal sides and 4 right angles is a square
const DiagramSquareDefinition = (() => {
  function render(cfg={}) {
    const width=380, height=355;
    const red='#cc2222', black='#1a1a1a', blue='#2D5FA6';
    const A=Geo.point(70,65), B=Geo.point(310,65), C=Geo.point(310,305), D=Geo.point(70,305);
